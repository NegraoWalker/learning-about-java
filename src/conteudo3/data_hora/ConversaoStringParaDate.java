...
public class ConversaoStringParaDate {
    public static void main(String[] args) {
        ...
        LocalTime horaLocal1 = LocalTime.parse("21:45:41.561900"); //Conversão de um String para uma hora
        System.out.println("Hora Local 1 [Conversão de String para hora - Formato no padrão ISO 8601]: " + horaLocal1);

        LocalDateTime dataEHoraLocal1 = LocalDateTime.parse("2025-05-14T13:30:42.561900"); //Conversão de um String para uma data e hora local
